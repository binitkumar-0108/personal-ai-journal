...
// ---------------------------------------------------------------------------
// Voice Recording
// Stored in Firebase Storage at: voice/{uid}/{entryId}.{ext}
// Metadata reference stored on the Firestore entry document.
// ---------------------------------------------------------------------------
...
export interface VoiceRecording {
  ...
  /** Public download URL. */
  url: string;
  /** MIME type used during recording e.g. audio/webm, audio/mp4. */
  mimeType: string;
  /** Duration in seconds if available. */
  durationSeconds?: number;
  /** When this recording was saved to Storage. */
  savedAt: Date;
}
...
export interface JournalEntry {
  ...
  /** Optional voice recording associated with this entry. */
